...
const Htm = () => {
    ...
    BOOTCAMP
    The HTML Handbook
    ⏬ Click here to download this book in PDF or ePUB
    Table of contents
    Table of contents
    1. Preface
    2. HTML Basics
    ...
    12. Images
    12.1. The figure tag
    12.2. Responsive images using srcset
    12.3. The picture tag
    13. Accessibility
    13.1. Use semantic HTML
    13.2. Use alt attributes for images
    13.3. Use the role attribute
    13.4. Use the tabindex attribute
    13.5. Use the aria attributes
    13.5.1. aria-label
    ...
    You can enforce a specific format on any field through the pattern attribute, which gives you the ability to set a regular expression to validate the value against.
    ...
    Bootcamp → Every year I organize a coding BOOTCAMP to teach you JS, Tailwind, React and Next.js (next edition Q1 2024)
    🏝️ → Go to SOLO LAB if you're into starting and running an Internet Business as a solo person (NEW COHORT IN OCTOBER, join the waiting list to stay in the loop)
    📚 →Read my 14 other free ebooks`
  return (
    <div className='Htm'>{text}</div>
  )
}
