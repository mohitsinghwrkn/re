  ...
  return (
    <div className='aboutUs'>
      <div className='aboutUs-top'>
        ...
        <p style={{fontSize:"20px", margin:"0px 20vw"}}>We are developer's developing the web elements to build an environment for humans willing to explore, create and evolve with everyday technologies</p>
        <p style={{fontSize:"16px", margin:"0px 10vw"}}>We are dedicated to providing developers with a comprehensive and innovative environment for their coding endeavors. Whether you're a seasoned professional or just starting your journey in the world of development, our platform is designed to support your growth, creativity, and productivity.</p>
      </div>
      <h3 style={{ textAlign: 'center', margin: "2vw" }}> <u></u>Our Team</h3>
